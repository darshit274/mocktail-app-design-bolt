...
import { CircleCheck as CheckCircle, Clock, Lock, Play, Calendar } from 'lucide-react-native';
import React, { memo, useCallback } from 'react';
import { StyleSheet, Text, TouchableOpacity, View } from 'react-native';
import DisplayHtml from '../common/DisplayHtml';

/**
 * Props for PurchasedTestSeriesCard component
 * @interface PurchasedTestSeriesCardProps
 */
interface PurchasedTestSeriesCardProps {
...
/**
 * PurchasedTestSeriesCard Component
 *
 ...
 * ```
 *
 * @param {PurchasedTestSeriesCardProps} props - Component props
...
export const PurchasedTestSeriesCard = memo<PurchasedTestSeriesCardProps>(({
    series,
    index,
    accessData,
    buttonState,
        ...
        >
            ...
            <View style={styles.statsContainer}>
                <View style={styles.statItem}>
                    ...
                    <Text style={[styles.statText, { color: Colors.textSubtle }]}>Enrolled On {formatDate(series?.enrolled_at)}</Text>
                </View>
                <View style={styles.statItem}>
                    <Calendar size={16} color={Colors.textSubtle} />
                    <Text style={[styles.statText, { color: Colors.textSubtle }]}>Valid Till {formatDate(series?.expiry_date)}</Text>
                </View>
                <View style={styles.statItem}>
...
PurchasedTestSeriesCard.displayName = 'PurchasedTestSeriesCard';
